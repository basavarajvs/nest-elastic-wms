...
import { BarcodeLabelResponseDto, GenerateBarcodeLabelDto } from '../dtos/barcode-label-response.dto';
...
export class BarcodeLabelController {
  ...
  @ApiCreatedResponse({ type: BarcodeLabelResponseDto })
  async generate(@Req() req: any, @Body() dto: GenerateBarcodeLabelDto) {
  ...
  @ApiOkResponse({ type: BarcodeLabelResponseDto })
